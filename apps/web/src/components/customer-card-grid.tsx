...
function CustomerCard({ customer, onEdit, onRequestDelete }: CustomerCardProps) {
    return (
...
export function CustomerCardGrid({
    ...
    function handleLoadMore() {
        const page = getCustomersPage(filtered, {
            cursor: visible.length > 0 ? String(visible[visible.length - 1]!.id) : null,
            ...
            <ConfirmDialog
                ...
                description={
                    <>
                        ...
                        and their account history will be permanently removed. This
