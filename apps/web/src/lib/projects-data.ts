...
export const initialProjects: Project[] = [
  {
    ...
    tasks: [
      ...
      {
        id: "pt-3",
        title: "Build dashboard metrics view",
        status: "in_progress",
        assignee: "Robert Fox",
        assigneeInitials: "RF",
        due: "2026-02-02",
      ...
      {
        id: "pt-4",
        title: "QA role transitions",
        status: "todo",
        assignee: "Tania Brooks",
        assigneeInitials: "TB",
        due: "2026-02-08",
      },
      {
    ...
    activity: [
      ...
      },
      {
        ...
        initials: "AM",
        action: "completed",
        target: "Define permission matrix",
        at: "5h ago",
      },
      {
        id: "pa-3",
    ...
    tasks: [
      {
        ...
        title: "Audit charts",
        status: "done",
        assignee: "Kiara Laras",
        assigneeInitials: "KL",
        due: "2026-08-24",
      },
      {
        id: "pt-7",
        title: "Build KPI grid",
        status: "in_progress",
        assignee: "Megan Chen",
        assigneeInitials: "MC",
        due: "2026-08-31",
